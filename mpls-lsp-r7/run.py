...
grade=0
grade += checkNPaths("r2","R2-R3-R1-R6-R7,R2-R3-R5-R6-R7")/5
grade += checkSinglePath("r1","R1-R6-R7")
grade += checkNPaths("r3","R3-R1-R6-R7,R3-R5-R6-R7")/5
grade += checkSinglePath("r5","R5-R6-R7")
grade += checkSinglePath("r4","R4-R5-R6-R7")
