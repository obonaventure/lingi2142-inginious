...
grade=0
grade += checkSinglePath("r2","R2-R3-R1")/5
grade += checkSinglePath("r7","R7-R6-R1")/5
grade += checkSinglePath("r3","R3-R1")/5
grade += checkNPaths("r5","R5-R3-R1,R5-R6-R1")/5
grade += checkNPaths("r4","R4-R5-R3-R1,R4-R5-R6-R1")/5
